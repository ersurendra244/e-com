...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            @can('menu create')
            <a href="{{ route('admin.subcategory', $subcategory->slug) }}" class="btn btn-sm btn-dark float-right">Go Back</a>
            <a href="javascript:void(0)" onclick="addnew()" class="btn btn-sm btn-primary float-right mr-2">Add New</a>
            <a href="{{ route('admin.subcategory.form_view', $subcategory->slug) }}" class="btn btn-sm btn-warning float-right mr-2">View Form</a>
            @endcan
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="manageForm" action="{{ route('admin.sub_categories.form_fields_save') }}" method="post"
...
@push('child_scripts')
    <script>
        ...
        function addnew(id) {
            ...
            if (id) {
                $.ajax({
                    url: "{{ route('admin.subcategory.form_fields_edit') }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
                        id: id
