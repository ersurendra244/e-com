...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <a href="{{ roleRoute('categories') }}" class="btn btn-sm btn-dark float-right">Go Back</a>
                    <h4 class="card-title">{{ $title }}</h4>
                    <form action="{{ roleRoute('categories.update', $edit_data->id ) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="parent_id" class="form-control" id="parent_id">
                                        ...
                                        @foreach ($categories as $key => $value)
                                            <option
                                                {{ isset($edit_data->parent_id) && $edit_data->parent_id == $value->id ? 'selected' : '' }}
